...
const ShopPrimary = ({ filteredItems }) => {
  ...
  return (
    <div className="tj-modal-container">
      <style jsx global>{`
        .tj-product-area .tj-shop-list-title {
          color: #1B3A6B;
        }
        .tj-product-area .tj-primary-btn,
        .tj-product-area .pagination .page-link {
          background-color: #1B3A6B !important;
          border-color: #1B3A6B !important;
          color: white !important;
        }
        .tj-product-area .tj-primary-btn:hover,
        .tj-product-area .pagination .page-link:hover {
          background-color: #29B6D8 !important;
          border-color: #29B6D8 !important;
          color: #1B3A6B !important;
        }
        .tj-product-area .shop-sidebar .widget-title {
          color: #1B3A6B;
        }
        .tj-product-area .shop-sidebar a {
          color: #1B3A6B;
        }
        .tj-product-area .shop-sidebar a:hover {
          color: #29B6D8;
        }
        .tj-product-area .product-card {
          border: 1px solid rgba(27,58,107,0.1);
          transition: all 0.3s;
        }
        .tj-product-area .product-card:hover {
          border-color: #29B6D8;
