        ...
        <div className="row align-items-stretch gy-5">
          <div className="col-lg-6 d-flex flex-column">
            <div className="about-image-wrapper">
              <Image
                src="/images/mssn/Community.jpeg"
            ...
            <div className="about-content">
              ...
              <h2 className="section-title">
                ...
                <span className="gradient-text">
                  Quietly Crept Into Nigeria
                </span>
              </h2>
              <div className="history-text">
                <p>
                  In an era where Muslim students were forced to renounce their
                  faith or adopt baptized names to gain admission into schools,
                  a spark of defiance ignited in Lagos. On{" "}
                  <strong>April 18th, 1954</strong>, 14 visionary students from
                  Methodist Boys' High School and other secondary schools
                  gathered at Ansar-ud-Deen Primary School, Alakoro, to draft a
                  constitution.
                </p>
                <p>
                  Their efforts culminated on{" "}
                  <strong>Sunday, May 30th, 1954</strong>, with the official
                  birth of the Muslim Students' Society of Nigeria (MSSN). By
                  1955, the movement had spread nationally, culminating in its
                  formal incorporation with the Federal Ministry of Internal
                  Affairs on <strong>October 14th, 1982</strong>. Today, the
                  MSSN stands as a unified force for Islamic propagation,
                  student welfare, and the liberation of the Ummah.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-12">
            <div className="base-container d-flex flex-wrap justify-content-center align-items-stretch gap-4">
              <div className="base-card">
                ...
                <p className="vm-text">
                  To establish an Ummah governed by the principles and rules of
                  the Shari'ah.
                </p>
              </div>
              <div className="base-card">
                ...
                <p className="vm-text">
                  ...
                  that fosters all-round human development by strengthening the
                  Ummah educationally, spiritually, and politically.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="row mt-4">
          <div className="col-12 text-center">
            <a href="#aims" className="btn-outline-cta">
              Discover Our Aims <span className="arrow">→</span>
            </a>
          </div>
        </div>
      </div>
      <style jsx>{`
        /* Paste your existing About3 styles here */
        .mssn-about-section {
